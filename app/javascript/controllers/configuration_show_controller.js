...
export default class extends Controller {
  ...
  async copyConfigurationInfo(event) {
    const configurationName = this.titleTarget.textContent.replace('|', '').trim()
    const copyText = `${configurationName}`

    try {
      await navigator.clipboard.writeText(copyText)
      this.showToast('Configuration Name copied to clipboard! 📋')
