...
Status.find_or_create_by(name: "Available", for_class: "Flat")
Status.find_or_create_by(name: "Blocked", for_class: "Flat")
Status.find_or_create_by(name: "Booked", for_class: "Flat")
Status.find_or_create_by(name: "Available", for_class: "Parking")
Status.find_or_create_by(name: "Booked", for_class: "Parking")
